...
| **[detect-changes](actions/detect-changes/README.md)** | Lightweight composite action that identifies modified files, ignores doc/formatting changes, and outputs whether builds/tests/tagging are needed. | `ronmkr/r_git_actions/actions/detect-changes@v1` | Composite |
| **[create-tag](actions/create-tag/README.md)** | Lightweight composite action to create and push annotated git tags (`X.Y.Z`) conditionally based on SemVer bumps. | `ronmkr/r_git_actions/actions/create-tag@v1` | Composite |
| **[generate-release-audit](actions/generate-release-audit/README.md)** | Audits all Jira issues, merged PRs, and review approvals between two tags, and fails if committer self-approvals are detected. | `ronmkr/r_git_actions/actions/generate-release-audit@v1` | Node 24 |
